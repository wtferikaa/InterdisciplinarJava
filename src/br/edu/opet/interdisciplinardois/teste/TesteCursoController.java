...
public class TesteCursoController {
    ...
    public static void main(String[] pArgs) throws ParseException
    {
     ...
     // Criar um departamento
        DepartamentosOpet tDepartamentosOpetA = new DepartamentosOpet(0, "qualquerdepartamento@gmail.com", "12345", "Departamento Qualquer");
        ...
        Ideia tIdeiaA = new Ideia (0, "ideia 1", "problema 1", "resolver o problema 1", tDataCadastro1, tDataAnalise1, true, "resposta 1", tAluno2a.getId(), tDepartamentosOpet2a.getId());
	...
	tCursoB.setNome(tCursoB.getNome() + " DIREITO");
	tCursoB.setNomeCoordenador("Ronaldo Rodrigues Robaldo");

    System.out.println();
    System.out.println("Atualizando um Curso para um id que existe");
