...
public class TesteIdeiaController {
	...
	public static void main(String[] pArgs) throws ParseException {
		...
		//
		// Criar um Curso
        Curso tCursoA = new Curso(0, "maria@gmail.com", "maria123", "Estética",
    			"maria");
        Curso tCursoB = new Curso(0, "ronaldo@gmail.com", "ronaldo123", "TDS",
    			"Ronaldo");
        Curso tCursoC = new Curso(0, "fernando@gmail.com", "fernando123", "Engenharia",
    			"Fernando");
        ...
        Aluno tAlunoA = new Aluno(0, "miley@gmail.com", "mi123", "Miley", 419981738, "Noite", "Estética",
				tCurso2a.getId());
        Aluno tAlunoB = new Aluno(0, "noah@gmail.com", "noah123", "Noah", 419768718, "Manhã", "TDS",
				tCurso2b.getId());
     ...
     // Criar departamentos
        DepartamentosOpet tDepartamentosOpetA = new DepartamentosOpet(0, "departamentoUm@gmail.com",
				"senha1", "Departamento Um");
        DepartamentosOpet tDepartamentosOpetB = new DepartamentosOpet(0, "departamentoDois@gmail.com",
				"senha2", "Departamento Dois");
        DepartamentosOpet tDepartamentosOpetC = new DepartamentosOpet(0, "departamentoTres@gmail.com",
				"senha3", "Departamento Tres");
        ...
        //ideia
		Ideia tIdeiaA = new Ideia(0, "ideia irineia 1", "problema irineia 1", "resolver o problema irineia 1", LocalDate.of(2017, 11, 02),
				LocalDate.of(2017, 11, 03), true, "resposta irineia", tAluno2a.getId(), tDepartamentosOpet2a.getId());
		...
		// Criando o objeto de Controller
			     ...
			     // Incluir a ideia para um departamento que nao existe
					...
					Ideia tIdeiaC = new Ideia(0, "ideia estranha", "problema estranho", "resolver o problema estranho", LocalDate.now(),
							LocalDate.of(2017, 11, 04), false, "resposta estranha", tAluno2a.getId(), tDepartamentosOpet2a.getId());
